<svg class="c-hero__svg" width="448" height="84" xmlns="http://www.w3.org/2000/svg">
    <defs>
        <clipPath id="let3">
    ...
    <g>
        <path class="c-hero__letter-1" fill="red" d="M.91 84V.965H23c8.232 0 13.613.396 16.143 1.19 4.04 1.283 7.372 4.02 9.997 8.212 2.624 4.192 3.936 9.591 3.936 16.2 0 6.003-1.133 11.035-3.398 15.094-2.266 4.06-5.098 6.91-8.496 8.553-3.399 1.642-9.252 2.464-17.559 2.464h-9.006V84H.91zm13.707-68.988v23.562h7.59c5.098 0 8.562-.359 10.394-1.076 1.831-.717 3.332-2.01 4.503-3.88 1.17-1.869 1.755-4.163 1.755-6.882 0-2.756-.604-5.078-1.812-6.966-1.208-1.888-2.7-3.153-4.475-3.795-1.774-.642-5.532-.963-11.271-.963h-6.684z" />
        <path class="c-hero__letter-2" fill="orange" d="M64.404 84V.965h50.524v14.047H78.11V33.42h34.211v13.99h-34.21v22.6h38.062V84z" />
        <g clip-path="url(#let3)">
            <rect class="c-hero__letter-3" x="0" y="0" width="100%" height="100%" fill="yellow"></rect>
        </g>
        <path class="c-hero__letter-4" fill="green" d="M196.49 84V.965h50.524v14.047h-36.817V33.42h34.211v13.99h-34.21v22.6h38.062V84z" />
        <g clip-path="url(#let5)">
            <rect class="c-hero__letter-5" x="0" y="0" width="100%" height="100%" fill="grey"></rect>
        </g>
        <g clip-path="url(#let6)">
            <rect class="c-hero__letter-6" x="300" y="0" width="100" height="100%" fill="pink"></rect>
        </g>
        <g clip-path="url(#let7)">
            <circle class="c-hero__letter-7" cx="390" cy="40" r="100" fill="blue" />
        </g>
    </g>
