...
<body class="app">
    ...
    <div class="peers ai-s fxw-nw h-100vh">
        <div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv" style="background-image:url(assets/static/images/bg.jpg)">
            <div class="pos-a centerXY" style="z-index: 20;">
                <div class="bgc-white bdrs-50p pos-r" style="background-color: transparent !important;width:120px;height:120px"><img class="pos-a centerXY"  src="assets/static/images/logo.png" alt=""></div>
            </div>
